...
This app contains four different machine learning models Iris Classification, Car Price Prediction, House Price Prediction and Heart Diasease Classification
...
```
git clone https://github.com/Eeshan2001/LnB-Final-Project.git
```
